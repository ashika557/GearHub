                ...
                <% if (feeds != null && !feeds.isEmpty()) { %>
        			...
        			<% for (feedbackModel data : feeds) { %>
            			<tr>
                			...
                			<td>
                			    <form action="${pageContext.request.contextPath}/deleteFeedbackServlet" method="post" style="display: inline;">
                			        <input type="hidden" name="userName" value="<%= data.getUserName() %>">
                			        <input type="hidden" name="email" value="<%= data.getEmail() %>">
                			        <input type="hidden" name="feedback" value="<%= data.getFeedback() %>">
